class RegistrationsController < Devise::RegistrationsController
  ...
  #   both_valid = @billing_address.valid? # checks internal validations only
  ...
  #     @billing_address.save
  #     
  #     if @billing_address.externally_valid? && resource.default_shipping_address.externally_valid?
  #       # everything is cool
  #       sign_in(resource_name, resource)
  #       respond_with resource, :location => redirect_location(resource_name, resource)
  #     else # need to give user the option to validate their address
  #       session[:source_c] = "account"
  #       session[:source_a] = "store_more_boxes"
  #       
  #       @addresses_to_validate = Array.new
  #       @addresses_to_validate << @billing_address if !@billing_address.was_externally_valid? || @billing_address.changes_suggested?
  #       @addresses_to_validate << @user.default_shipping_address if !@user.default_shipping_address.was_externally_valid? || @user.default_shipping_address.changes_suggested?
  #       
  #       sign_in(resource_name, resource)
  #       
  #       render "account/external_addresses_validate"
  #     end
  #     
  ...
  #     # end
  #   else # user and address are not both valid
